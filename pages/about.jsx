      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16">
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-gray-700">
              With PRISM, clinicians can upload patient CT scans to visualize crucial organs and tumors, and during surgery, the MR headset provides real-time detection of organs and blood vessels, potentially reducing complication rates by 10–30%.
            </p>
          </div>
          <div className="md:w-1/2 flex justify-center">
            <div className="bg-purple-100 w-64 h-64 rounded-lg flex items-center justify-center text-purple-700 font-bold text-xl">
              PRISM Image
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-purple-50 rounded-lg shadow-md">
            ...
            <p className="text-gray-700">Combining AI and mixed reality for next-generation surgical support.</p>
          </div>
          <div className="p-6 bg-green-50 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-green-600 mb-2">Accessibility</h3>
            <p className="text-gray-700">Designed to be low-cost and easy to integrate into clinical workflows.</p>
          </div>
          <div className="p-6 bg-purple-50 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-purple-700 mb-2">Impact</h3>
            <p className="text-gray-700">Helping reduce complication rates and improve patient outcomes.</p>
          </div>
        </div>
      </div>
    </motion.div>
